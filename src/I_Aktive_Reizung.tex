...
\subsection{1\c\rs1\d\ra} \label{subsec:1c1d}
...
\begin{bids}
	...
	1\s     & 11\rplus, Zweifärber 5\rplus\c4\rplus\s, fast nie zu passen \tbd{Alternative 11-18} \ensuremath{\rightarrow} \ref{subsubsec:1c1d1S} \\
	...
	2\d     & 16\rplus, starker Zweifärber 5\rplus\c4\rplus\d, fast nie zu passen \ensuremath{\rightarrow} \ref{subsubsec:1c1d2d} \\
	2\h     & 11-15, 3\rplus\h{} (3er fit kann nur 1345 sein, meist 4er) \ensuremath{\rightarrow} \ref{subsubsec:1c1d2H} \\
	2\s\rka & 10\rplus, 6\rplus\c5\rplus\s \tbd{Alternative 19\rplus, 5\rplus\c4\rplus\s} \ensuremath{\rightarrow} \ref{subsubsec:1c1d2S} \\
...
\subsubsection{1\c\rs1\d\ra1\h\ra} \label{subsubsec:1c1d1H}
...
\subsubsection{1\c\rs1\d\ra1\h\ra2\c\ra} \label{subsubsec:1c1d1H2c}
...
\subsubsection{1\c\rs1\d\ra1\s} \label{subsubsec:1c1d1S}

\subsubsection{1\c\rs1\d\ra1SA\ra} \label{subsubsec:1c1d1SA}

\subsubsection{1\c\rs1\d\ra2\c} \label{subsubsec:1c1d2c}

\subsubsection{1\c\rs1\d\ra2\d} \label{subsubsec:1c1d2d}

\subsubsection{1\c\rs1\d\ra2\h} \label{subsubsec:1c1d2H}

\subsubsection{1\c\rs1\d\ra2\s} \label{subsubsec:1c1d2S}

\subsubsection{1\c\rs1\d\ra2SA\ra} \label{subsubsec:1c1d2SA}

\subsection{1\c\rs1\h\ra} \label{subsec:1c1H}
...
\begin{bids}
	...
	2\d     & 16\rplus, starker Zweifärber 5\rplus\c4\rplus\d, fast nie zu passen \ensuremath{\rightarrow} \ref{subsubsec:1c1H2d} \\
	2\h     & 16\rplus, starker Zweifärber 5\rplus\c4\rplus\h, fast nie zu passen \ensuremath{\rightarrow} \ref{subsubsec:1c1H2H} \\
...
\subsubsection{1\c\rs1\h\ra1\s\ra} \label{subsubsec:1c1H1S}
...
\subsubsection{1\c\rs1\h\ra1SA\ra} \label{subsubsec:1c1H1SA}

\subsubsection{1\c\rs1\h\ra2\c} \label{subsubsec:1c1H2c}

\subsubsection{1\c\rs1\h\ra2\d} \label{subsubsec:1c1H2d}

\subsubsection{1\c\rs1\h\ra2\h} \label{subsubsec:1c1H2H}

\subsubsection{1\c\rs1\h\ra2\s} \label{subsubsec:1c1H2S}

\subsubsection{1\c\rs1\h\ra2SA\ra} \label{subsubsec:1c1H2SA}

\subsection{1\c\rs1\s\ra} \label{subsec:1c1S}
...
\subsection{1\c\rs1SA} \label{subsec:1c1SA}
...
\subsection{1\c\rs2\c\ra} \label{subsec:1c2c}
...
\subsection{1\c\rs2\d\ra} \label{subsec:1c2d}
...
\subsection{1\d\rs1\h} \label{subsec:1d1H}
...
\subsection{1\d\rs1\s} \label{subsec:1d1S}
...
\subsection{1\d\rs1SA} \label{subsec:1d1SA}
...
\subsection{1\d\rs2\c\ra} \label{subsec:1d2c}
...
\subsection{1\d\rs2\d\ra} \label{subsec:1d2d}
