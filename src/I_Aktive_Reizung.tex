...
1SA\ra{} zeigt einen starken Einfärber, 2SA\ra{} ist eine starke Hebung der Oberfarbe. Dies ermöglicht, dass 3\c{} und 4\M{} jetzt immer extreme Verteilungen zeigen und 3SA als to play zur Verfügung steht.

\begin{bids}
	Pass    & verboten \\
	1\h\ra  & 12-14 balanced, 2-4\h \\
	1\s     & 11\rplus, Zweifärber 5\rplus\c4\rplus\s, fast nie zu passen \\
	1SA\ra  & 16\rplus, starker Einfärber mit 6\rplus\c \\
	...
	2\s\rka & 10\rplus, 6\rplus\c5\rplus\s \\
...
\begin{bids}
	Pass    & verboten \\
	1\s     & 11\rplus, 4\rplus\rplus\d4\rplus\s, fast nie zu passen \\
	...
	2\s\rka & 10\rplus, 6\rplus\d5\rplus\s \\
...
\begin{figure}[h]
	...
	\begin{tabular}{c | c c c}
	 	 ...
	 	 (3\rminus3\rminus) 	& \makecell{pass \\ Transfer auf 3m}
	 	 			...
	 	 			& \makecell{2SA mit 5\rplus5\rplus mm \\ 2\s{} sonst \\ 3\c{} geht auch} \\[25pt]
	 	 (43\rminus)	& \makecell{pass \\ 2\c{} mgl mit 7FL 5\rplus m \\ Transfer auf 3m}	
	 	 			& \makecell{2\c{} (fit: raise, kein fit: 2SA)} 
	 		 		& \makecell[c]{3SA \\ (41)44: 3M \\ 2\c{} ohne SI \\ 3\c{} möglich\\ 2\s{} mit Kürze in M} \\[35pt]
	 	 44			& \makecell{pass \\ 2\c{} mgl mit 7FL 5\rplus m \\ Transfer auf 3m} 	
		 	 		& \makecell{2\c{} (fit: raise, kein fit: 2SA)} 
		 	 		& \makecell{2\c{} (fit: other major für SI) \\ 3SA \\ kein 3\c!} \\[30pt]
	 	 (53\rminus) 	& Jacobi 
		 	 		& \makecell{Jacobi (dann Trnf mit 5m/raise) \\ 2\c{} mit 5\s{}3\h{} oder 5\s{} ohne 5\rplus m} 	
...
Was hier als Transfer auf 3m steht ist je nach Situation 2\s{} mit Ziel 3\c{} oder 2SA pick a minor / Ziel 3\d.

\begin{bids}
	2\c\rs & Stayman \tbd{ab wie vielen Punkten?}\\
	2\d\rs & \h-Transfer \\
	2\h\rs & \s-Transfer \\
	2\s\ra & inv. oder \c-Transfer \\
...
\begin{bids}
	...
	& \subbids{
		...
		2SA & inv (5\h{} 4\s{} ist möglich) $\rightarrow$ alles außer pass nimmt an \\
