...
Auch hier ist Two-Way-Checkback an. Hier ist zu beachten, dass Eröffner eine größere Range an Punkten und Verteilungen haben kann.
\tbd{Daher ist abzuwägen, ob 1\c\rs{} 1\d\ra{} 1\s{} 2\c\ra{} 2\d\ra{} in diesem Fall forcing sein sollte, bzw. ob es Hände gibt, mit denen man aus der Sequenz ausbricht und etwas anderes als 2\d bietet}
