...
\begin{bids}
	...
	2\s\ra  & 10\rplus, 6\rplus\c5\rplus\s \\
...
Unbalanced Hände, die mit 1\d{} eröffnet werden sind entweder \c-Einfärber, Zweifärber mit \c{} als längste Farbe, oder 4441-Hände mit 4er\d.

\section{Antworten auf 1\d\ra}
...
\begin{itemize}
	\item Mit gf Händen ohne 5er-OF reizt man 2\c\ra{} (4er-OF zeigt man später)
	\item Mit 44 in den Oberfarben ohne gf reizt man 1\h\ra
	\item Mit 5\rplus\s4\rplus\h{} antwortet man ohne gf 2\d\ra, mit gf 1\s\ra
\end{itemize}

Antworten auf 1\d\ra:
\nopagebreak
